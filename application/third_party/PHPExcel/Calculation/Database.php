...
class PHPExcel_Calculation_Database {
	 ...
	 * DSTDEV
	 *
	 * Estandries the standard deviation of a population based on a sample by using the numbers in a
	 ...
	 * DVAR
	 *
	 * Estandries the variance of a population based on a sample by using the numbers in a column
