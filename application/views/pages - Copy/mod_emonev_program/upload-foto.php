<?php
	...
	$row=$this->m_action->ambilData("select FOTO, JENIS_CPCL, KDKEGUNIT, KDDEWAN, UNITKEY from dbsipd_".$_tahun.".t_kegiatan_cpcl where KDCPCL='".$id."'");		
	...
	<div class="widget-box">
	  ...
	  <div class="widget-content">
		...
		<div class="control-group">
				...
				<center>
					<input type="submit" value="Kembali" onclick="parent.location='<?=base_url("login/pages/".$Pr."/list/Aksi/".$JENIS_CPCL."/".$KDKEGUNIT."/".$KDDEWAN."/".$UNITKEY)?>'" class="btnSubmit" />
