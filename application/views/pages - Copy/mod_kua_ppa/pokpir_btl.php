...
<div class="widget-content">		
  ...
  <tbody>		   
	<?php			
		...
		WHERE (a.TGLVALID NOT IN ('0000-00-00') OR a.TGLVALID IS NOT NULL) and a.KDTAHAP='{$KDTAHAP}' AND  a.UNITKEY='{$UNITKEY}' AND a.JENIS_CPCL='{$JENIS_CPCL}' ".$wh." order by i.KDUNIT");
