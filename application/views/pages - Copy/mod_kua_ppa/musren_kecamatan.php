...
<div class="widget-content">		
  ...
  <tbody>		   
	<?php			
		...
		WHERE (a.TGLVALID NOT IN ('0000-00-00') OR a.TGLVALID IS NOT NULL) and a.KDTAHAP='{$KDTAHAP}' AND  a.UNITKEY='{$UNITKEY}' AND a.JENIS_CPCL='{$JENIS_CPCL}' order by i.KDUNIT");
		...
		foreach ($qry->result() as $row){	
			...
			{$KODE_KEC=$row->KODE_KEC;echo "<tr bgcolor='#339900'><td colspan=14>".$row->KODE_KEC." ".$row->NMKEC."</td></tr>";$i=1;}
