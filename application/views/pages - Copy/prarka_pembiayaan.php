<?php
	...
	//// Rekening
	$Qry="SELECT a.MTGKEY, a.KDREK, a.NMREK, b.NILAI FROM dbsipd_".$_tahun.".mrekb AS a LEFT JOIN (SELECT MTGKEY, NILAI FROM dbsipd_".$_tahun.".t_raskb WHERE UNITKEY='".@$UNITKEY."' AND KDTAHAP='".$KDTAHAP."') AS  b ON a.MTGKEY=b.MTGKEY WHERE LEFT(a.KDREK,3)='6.1' AND a.KDSTREK='3'";
