...
$(document).ready(function (e) {
	$("#uploadForm").on('submit',(function(e) {
		e.preventDefault();
		$.ajax({
        	url: "<?=base_url('emonev/emon_kegiatan_upload_foto/'.$id)?>",
			type: "POST",
	...
	<div class="widget-box">
	  ...
	  <div class="widget-content">
		...
		<div class="control-group">
				...
				<center>
					<input type="submit" value="Kembali" onclick="parent.location='<?=base_url('login/pages/'.$Pr.'/list/kegiatan/'.$id)?>'" class="btnSubmit" />
