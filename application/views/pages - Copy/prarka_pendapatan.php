<?php
	...
	//// Rekening
	$Qry="SELECT a.MTGKEY, a.KDREK, a.NMREK, b.NILAI FROM dbsipd_".$_tahun.".mrekd AS a LEFT JOIN (SELECT MTGKEY, NILAI FROM dbsipd_".$_tahun.".t_raskd WHERE UNITKEY='".@$UNITKEY."' AND KDTAHAP='".$KDTAHAP."') AS  b ON a.MTGKEY=b.MTGKEY WHERE LEFT(a.KDREK,3)='4.1' AND a.KDSTREK='3'";
