		  ...
		  <div class="widget-content">
			<div class="control-group form-horizontal">				
				...
				<div class="control-group">
				  ...
				  <div class="controls">					
						<?=$this->m_auth->cmbQuery('UNITKEYKPA',@$UNITKEYKPA,"SELECT UNITKEY as '0', concat(KDUNIT,' ' ,NMUNIT) as '1'  FROM dbsipd_".$_tahun.".mkpa WHERE LEFT(KDUNIT,".@$DLEFT.") ='$KDUNIT' ")?>							
				  </div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					 <div class="input-append">
					  ...
					  <input type="text" placeholder='numeric' name="PAGUM1" id="PAGUM1" value="<?=floatval(@$PAGUM1)?>"  class="span7">
					  <span class="add-on">Rp</span> </div>
				   </div>
				</div>
		...
		<div class="widget-box">
		  ...
		  <div class="widget-content">
			<div class="control-group form-horizontal">
				...
				<?php
					$query=$this->db->query("SELECT a.KDKINERJA, a.NMKINERJA, b.TOLAK_UKUR, b.TARGET_KINERJA_N, b.TARGET_KINERJA_N1 from dbsipd_".$_tahun.".mkinerja_kegiatan AS a LEFT JOIN (SELECT KDKINERJA, TOLAK_UKUR, TARGET_KINERJA_N, TARGET_KINERJA_N1 FROM dbsipd_".$_tahun.".t_kegiatan_kinkeg WHERE   KDTAHAP='{$KDTAHAP}' AND UNITKEY='{$UNITKEY}' AND KDPRGRM='{$KDPRGRM}' AND KDKEGUNIT='{$KDKEGUNIT}') AS b ON a.KDKINERJA=b.KDKINERJA");
...
<script>	 
	$( document ).ready(function() {		
		...
		$('#btnsimpan').click(function(){	
			/* PAGU KEGIATAN SKPD */
			var PAGUM1=$('#PAGUM1').val();
			var KETERANGAN=$('#KETERANGAN').val();
			var KDRANCKEG=$('#KDRANCKEG').val();
			var UNITKEYKPA=$('#UNITKEYKPA').val();
			...
			var LAT=$('#lat').val();
			var LONGI=$('#long').val();
			var dataPost={PAGUM1:PAGUM1, KETERANGAN:KETERANGAN, UNITKEYKPA:UNITKEYKPA, KDRANCKEG:KDRANCKEG, KDTAHAP:KDTAHAP, UNITKEY:UNITKEY, KDPRGRM:KDPRGRM, KDKEGUNIT:KDKEGUNIT, KDSIFAT:KDSIFAT, KEGIATAN_PRIORITAS:KEGIATAN_PRIORITAS, SASARAN_KEGIATAN:SASARAN_KEGIATAN, LOKASI:LOKASI, TARGET:TARGET, SATUAN:SATUAN, PAGU:PAGU, PAGUN1:PAGUN1, LAT:LAT, LONGI:LONGI};
