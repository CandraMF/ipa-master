<?php
	...
	$row=$this->m_action->ambilData("select FOTO, JENIS_CPCL, MTGKEY, KDDEWAN, UNITKEY from dbsipd_".$_tahun.".t_btl_cpcl where KDCPCL='".$id."'");		
	...
	<div class="widget-box">
	  ...
	  <div class="widget-content">
		...
		<div class="control-group">
				...
				<center>
					<input type="submit" value="Kembali" onclick="parent.location='<?=base_url("login/pages/".$Pr."/list/Aksi/".$JENIS_CPCL."/".$MTGKEY."/".$KDDEWAN."/".$UNITKEY)?>'" class="btnSubmit" />
