  ...
  <tbody>		   
	<?php			
		...
		INNER JOIN dbsipd_".$_tahun.".mskpd AS b ON a.IDKEC=b.UNITKEY
		 WHERE a.KDTAHAP='{$KDTAHAP}' AND a.UNITKEY IN (SELECT UNITKEY FROM dbsipd_".$_tahun.".mbidang_skpd WHERE KDBIDANG ='{$KDBIDANG}' ".$wh.") AND a.JENIS_CPCL IN (2,4) ".$whm." 
