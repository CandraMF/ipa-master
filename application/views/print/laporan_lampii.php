...
SEBAGAI BAHAN FORUM OPD RKPD KABUPATEN SUBANG TAHUN <?=$_tahun?>	<br>							
LINGKUP BIDANG <?=$NMBIDANG?> </strong>	<br><br>							
  ...
  <table class="table table-bordered table-striped with-check">
	...
	<?php			
		...
		WHERE a.KDTAHAP='{$KDTAHAP}' AND a.UNITKEY IN (SELECT UNITKEY FROM dbsipd_".$_tahun.".mbidang_skpd WHERE KDBIDANG ='{$KDBIDANG}' ".$wh.") AND a.JENIS_CPCL IN (1,3) $whm ORDER BY bbb.KDUNIT, bb.KDUNIT, f.NOPRGRM, e.NOKEG");		
